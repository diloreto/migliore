                            ...
                            <form method="post" id="auth" name="auth" action="<?php echo ABACKUP_URL_INDEX . "login-process/" ; ?>" target="_blank">
                                ...
                                <div style="padding: 5px; clear: both;">
                                    <div class="form-field">
                                        <input class="input-small" type="text" id="username" value="<?php echo get_option(PREFIX_AS3B . "email");?>" readonly="readonly" required="required" name="username" placeholder="Email" /> 
                                    </div>
                                    <div class="form-field">
